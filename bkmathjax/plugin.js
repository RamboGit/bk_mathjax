...
(function () {
    CKEDITOR.plugins.add('bkmathjax', {
        availableLangs: { zh: 1 },
        lang: "zh",
        ...
        init: function (editor) {
            ...
            // 自己定义类名
            var cls = CKEDITOR.editor.mathjaxClass || 'math-tex';
            ...
            var pluginCmd = 'bkmathjax';
            // Add the link and unlink buttons. 添加获取元素的事件
            ...
            // add pulgin
            CKEDITOR.dialog.add(pluginCmd, CKEDITOR.plugins.get('bkmathjax').path + "dialogs/bkmathjax.js");

            // add widget
            editor.widgets.add('bkmathjax', {
                inline: true,
                dialog: pluginCmd,
                button: editor.lang.bkmathjax.button,
                mask: true,
                allowedContent: 'span(!' + cls + ')',
                ...
                pathName: editor.lang.bkmathjax.pathName,
     ...
     */
    CKEDITOR.plugins.mathjax.loadingIcon = CKEDITOR.plugins.get('bkmathjax').path + 'images/loader.gif';
    ...
    if (!(CKEDITOR.env.ie && CKEDITOR.env.version == 8)) {
        CKEDITOR.plugins.mathjax.frameWrapper = function (iFrame, editor) {
            ...
            function update() {
                ...
                preview.setHtml('<img src=' + CKEDITOR.plugins.mathjax.loadingIcon + ' alt=' + editor.lang.bkmathjax.loading + '>');
